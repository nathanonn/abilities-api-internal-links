...
/**
 * Ability to validate internal links in a post.
 */
class ValidateLinksAbility {
	...
	/**
	 * Execute the validate links ability.
	 *
	...
	public function execute( array $input ) {
		...
		return $this->link_validator->validate( $post );
	}
}
